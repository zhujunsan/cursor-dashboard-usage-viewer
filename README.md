...
<a href="https://cdn.jsdelivr.net/gh/zhujunsan/cursor-dashboard-usage-viewer@1.0.3/cursor-dashboard-usage-viewer.user.js" target="_blank" rel="noopener noreferrer">https://cdn.jsdelivr.net/gh/zhujunsan/cursor-dashboard-usage-viewer@1.0.3/cursor-dashboard-usage-viewer.user.js</a>
...
|-------------|----------|
| `@latest` | Resolves to the highest semver Git tag (e.g. `v1.0.3`). Best for auto-updates when releases are tagged. |
| `@1.0.3` | Pinned to a specific version. No stale-cache surprises; use for manual installs. |
...
2. Create a matching Git tag: `git tag v1.0.3 && git push origin v1.0.3`
